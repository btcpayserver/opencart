...
$_['entry_send_customer_email'] = 'Send customer email to BTCPay Server';
$_['entry_total'] = 'Total';
...
$_['help_send_customer_email'] = 'Disabled by default. Adds the customer email address from the order to new BTCPay invoices so BTCPay Server store email rules can send emails to the buyer. Configure these rules in your BTCPay Server store email settings.';
$_['warning_send_customer_email'] = 'Privacy warning: Enabling this stores the customer email address on the BTCPay invoice. Anyone with a leaked invoice ID or checkout link could access this email address. Disabling this later does not remove email addresses from existing invoices.';
